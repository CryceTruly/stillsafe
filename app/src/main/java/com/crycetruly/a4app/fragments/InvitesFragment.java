...
import com.crycetruly.a4app.EnlargeImageView;
import com.crycetruly.a4app.ProfileActivity;
import com.crycetruly.a4app.R;
import com.crycetruly.a4app.models.Request;
...
public class InvitesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View v = inflater.inflate(R.layout.fragment_invites, container, false);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (!dataSnapshot.exists()) {
                    try {
                        TextView friendtest = v.findViewById(R.id.inquition);
            ...
            protected void onBindViewHolder(final SentsViewHolder viewHolder, int position, final Request model) {
                ...
                Users.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        String usersName = dataSnapshot.child("phone").getValue().toString();
                ...
                viewHolder.cancel.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        viewHolder.cancel.setText("ACCEPTING Invite");
                        ...
                        notificationData.put("name", "User");
                        ...
                        rootRef.updateChildren(friendsMap, new DatabaseReference.CompletionListener() {
                            ...
                            public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                                try {
                                    ...
                                    Toast.makeText(getContext(), "Invite accept success", Toast.LENGTH_SHORT).show();
