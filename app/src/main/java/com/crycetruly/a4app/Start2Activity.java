...
public class Start2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.friendreportlayout);
    ...
    private void validate() {
        ...
        if (TextUtils.isEmpty(reported_by)) {
            Toast.makeText(this, "Please choose your relationship with Survivor", Toast.LENGTH_SHORT).show();
            return;
        }
    ...
    private void submitDataToFireStore(final String province, String reportedFrom, String years, String whenn, String description, String district, String phone, long reported) {
        ...
        stringMap.put("reported_by", reported_by);
        ...
        firestore.collection("cases").document(key).set(stringMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                Toast.makeText(Start2Activity.this, "", Toast.LENGTH_SHORT).show();
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(Start2Activity.this, "Failed to submit your case :"+e.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    private void telluser() {
        progressBar.setVisibility(View.GONE);
        submit.setText("Submit");
        Snackbar.make(layout,"Case reported",Snackbar.LENGTH_INDEFINITE).setAction("GET HELP FOR VICTIM", new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(getBaseContext(),DetailActivity.class);
                i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK|Intent.FLAG_ACTIVITY_NEW_TASK);
                Start2Activity.this.overridePendingTransition(R.anim.fade_in,R.anim.fade_out);
